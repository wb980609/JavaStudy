...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if(money <= brackets[0]){
            ...
            tax += CalTax(money, brackets[0],rates[1]);

            deduction = 1080000;
            deduct_tax = CalDeductTax(money, deduction, rates[1]);
            ...
            tax += CalTax(brackets[2], brackets[1],24);
            tax += CalTax(brackets[3], brackets[2],35);
            tax += CalTax(brackets[4], brackets[5],38);
            ...
            tax += CalTax(brackets[3], brackets[2],35);
            tax += CalTax(brackets[4], brackets[5],38);
            tax += CalTax(brackets[5], brackets[6],40);
